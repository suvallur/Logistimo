package com.ail.warmachine1.config;

import com.ail.warmachine1.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.ail.warmachine1.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.ail.warmachine1.repository.search")
